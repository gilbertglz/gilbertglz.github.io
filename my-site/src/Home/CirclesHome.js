...
function CirclesHome () {
  return (
    <div className='CirclesWrapper' style={{margin:'0%', display:"flex",justifyContent:'center', alignItems:'center', width:'100%', position:'absolute'}}>
        <Circles  negative = {false} style={{backgroundColor:'#EFEFEF',opacity:'.3',borderRadius:"50%",width:'35em', height:'35em'}}/>
        <Circles  negative = {true} style={{backgroundColor:'#E8AA42',opacity:'.4', borderRadius:"50%",width:'35em', height:'35em'}}/>
    </div>
  );
}
